...
class Camera_Controller : public Urho3D::Object
{
    URHO3D_OBJECT(Camera_Controller, Urho3D::Object)

  public:

	Camera_Controller(Urho3D::Context * context);
	~Camera_Controller();
  ...
  private:
    ...
    void _on_cam_orbit_set_point(const Urho3D::Vector2 & norm_mpos, Urho3D::Viewport * vp);
