...
class Selection_Controller : public Urho3D::Component
{
    URHO3D_OBJECT(Selection_Controller, Urho3D::Component)

  public:
    Selection_Controller(Urho3D::Context * context);
    ~Selection_Controller();

    void clear_selection();

    void create_selection_rect(Urho3D::UIElement * containing);

    bool is_selected(Urho3D::Node * obj_node);

    void snap_selection();

    void set_viewport(Urho3D::Viewport * vp);
