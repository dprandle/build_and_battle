...
class Input_Translator : public Urho3D::Object
{
  ...
  public:
    ...
    void push_viewport(const Viewport_Data & vp);
    void pop_viewport();
  ...
  private:
    ...
    void _fill_vp_info(Viewport_Info & vp_inf,
    ...
    Urho3D::Vector<Viewport_Data> vp_stack_;
...
{
/// Input Trigger Event
URHO3D_EVENT(E_INPUT_TRIGGER, Input_Trigger)
{
    ...
    URHO3D_PARAM(P_VIEWPORT_PTR, viewport_ptr);                            // Urho3D::Viewport
